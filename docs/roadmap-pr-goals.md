...
Captured: 2026-05-14 (Asia/Seoul) during the Gi Code 2.0 Ultragoal run.
...
- Merge only PRs that are still relevant to Gi Code 2.0, are non-draft, target `main`, and are conflict-free after a fresh mergeability refresh.
...
These may be broader than the Gi Code 2.0 roadmap scope and need a product-fit decision before merge.
