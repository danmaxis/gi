...
This file provides guidance to Gi Code (clawcode.dev) when working with code in this repository.
...
- Keep shared defaults in `.gi.json`; reserve `.gi/settings.local.json` for machine-local overrides.
